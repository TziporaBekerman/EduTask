...
-- ASSIGNMENTS (ישנים - בהערה למניעת כפילות)
-- INSERT INTO Assignments
-- (id, title, description, groupId, lecturerId, openDate, closeDate)
-- VALUES
-- (1,'React Components','Build a React application with reusable components',1,2,'2026-05-01 08:00:00','2026-05-15 23:59:59'),
-- (2,'Node REST API','Create REST API using Express',2,2,'2026-05-03 08:00:00','2026-05-18 23:59:59'),
-- (3,'MySQL Database Design','Design relational database for school system',3,3,'2026-05-05 08:00:00','2026-05-20 23:59:59');

-- SUBMISSIONS (ישנים - בהערה למניעת כפילות)
